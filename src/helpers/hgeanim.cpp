...
hgeAnimation::hgeAnimation(HTEXTURE tex, int nframes, float FPS, float x, float y, float w, float h): hgeSprite(tex, x, y, w, h)
{
...
hgeAnimation::hgeAnimation(const hgeAnimation & anim): hgeSprite(anim)
{ 
